...
Route::get('/order', [App\Http\Controllers\OrderController::class, 'index'])->middleware(['throttle:limitpizza'])->name('order');
...
Route::post('order', [App\Http\Controllers\OrderController::class, 'AddToCart'])->middleware(['throttle:limitpizza']);
